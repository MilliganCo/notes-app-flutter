...
# Яндекс API ключи
YANDEX_GEOCODE_API_KEY = "fc164944-953f-414a-8f60-1b7207f2273f"
YANDEX_SEARCH_API_KEY = "2e009d84-3660-463f-9607-60b4714b2072"
...
# Функция поиска метро через Яндекс Search API
...
def get_user_coordinates():
    ...
    latitude = simpledialog.askfloat("Координаты", "Введите широту:")
    longitude = simpledialog.askfloat("Координаты", "Введите долготу:")
...
def main():
    ...
    if user_lat is None or user_lon is None:
        print("Координаты не введены. Завершение.")
        return

    # Поиск записок
    notes_nearby = search_notes_near_user(user_lat, user_lon)
