...
def find_nearest_address_with_catalog(coords):

   """

   Найти ближайший адрес через Catalog API 2ГИС.
   ...
   try:
       ...
       if "result" in data and "items" in data["result"] and data["result"]["items"]:
           ...
           address = item.get("address_name", "Unknown address")
...
def process_input():
   ...
   try:
       ...
       for i in range(len(usernames)):
           ...
           nearest_address = find_nearest_address_with_catalog(coords)
