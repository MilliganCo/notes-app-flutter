...
import sqlite3
import os
from tkinter import Tk, Text, Button, Label, END, messagebox
...
def handle_user_choice():
    choice = messagebox.askquestion("Действие", "Сгенерировать новые 50 записок?")
    if choice == "yes":
        action = messagebox.askyesnocancel("Выбор", "Стереть всё или добавить новые?")
        if action is None:
            return
        elif action:
            clear_database()
        ...
        messagebox.showinfo("Пропустить", "Запускаем скрипт с существующими данными.")
